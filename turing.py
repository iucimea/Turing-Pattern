...
def file_read():
    ...
    if os.path.isfile(filename):
        ...
        file_read.n = parser.getint('settings','n') # grid size
        file_read.delta_t = parser.getfloat('settings','delta_t') # temporal resolution
        file_read.simulation_steps = parser.getint('settings','simulation_steps') # number of delta_t steps performed 
...
n = file_read.n
delta_t = file_read.delta_t  # temporal resolution
simulation_steps = file_read.simulation_steps  # number of delta_t steps performed 
